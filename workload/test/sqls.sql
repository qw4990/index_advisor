...
select * from test.test_t1, test.test_t2 where t1.a=t2.a and t1.b<10 and t2.b<10;
select * from test.test_t1, test.test_t2 where t1.a=t2.a and t1.d in (1, 2, 3) and t2.c=10;